import React, { useRef, useEffect, useState, useImperativeHandle, useLayoutEffect } from 'react';
...
const BBoxAnnotator = React.forwardRef<any, Props>(function BBoxAnnotator(
    { url, borderWidth = 2, inputMethod, labels, onChange, initialEntries },
    ref,
) {
    ...
    return (
        <div
            ...
            style={{
                width: bBoxAnnotatorStyle.width !== undefined ? `${bBoxAnnotatorStyle.width}px` : undefined,
                height: bBoxAnnotatorStyle.height !== undefined ? `${bBoxAnnotatorStyle.height}px` : undefined,
            }}
        ...
        >
            <div
                ...
                style={{
                    width: imageFrameStyle.width !== undefined ? `${imageFrameStyle.width}px` : undefined,
                    height: imageFrameStyle.height !== undefined ? `${imageFrameStyle.height}px` : undefined,
